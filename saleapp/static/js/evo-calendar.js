            ...
            _.initials = {
                ...
                dates: {
                    ...
                    vi: {
                        ...
                        noEventForToday: 'Không có sự kiện nào vào hôm nay!',
                        noEventForThisDay: 'Không có sự kiện nào vào ngày này!',
                        previousYearText: 'Năm trước',
                        nextYearText: 'Năm sau',
                        closeSidebarText: 'Đóng thanh bên',
            ...
            if (_.options.calendarEvents != null) {
                for (var i = 0; i < _.options.calendarEvents.length; i++) {
                    ...
                    if (!_.options.calendarEvents[i].id) {
                        console.log(
                            '%c Event named: "' + _.options.calendarEvents[i].name + '" doesn\'t have a unique ID ',
